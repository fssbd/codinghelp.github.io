...
public class TrainData extends JPanel {
	...
	static JTextField txt_search = new JTextField(29);
		...
		while (rows.hasNext())
		{
			...
			while (cells.hasNext())
			{
				...
				if (cell.getCellType() == HSSFCell.CELL_TYPE_STRING)
				{
					...
					array_index[l]=cell.getStringCellValue();
					l++;
				}
				else if(cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC)
				{
					...
					array_index[l]=cell.getNumericCellValue()+"";
					l++;
				}
				else
				{
	...
	public void btnAction()
	{
		btnCheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				for(int i=0;i<10;i++)
				{
					System.out.println(array_index[i]);
				}
			}
		});
	...
	public void panel_north_n_work()
	{
		...
		panel_north_n.add(new JLabel("Train Data"));
	}
	...
	public void panel_north_c_work()
	{
		...
		btnCheck.setPreferredSize(new Dimension(92,50));
