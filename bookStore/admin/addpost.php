            ...
            <div class="box round first grid">
				...
				<?php
					if($_SERVER['REQUEST_METHOD'] == 'POST')
					{
						...
						$cat    = mysqli_real_escape_string($db->link1, $_POST['cat']);
						$body   = mysqli_real_escape_string($db->link1, $_POST['body']);
						$tags   = mysqli_real_escape_string($db->link1, $_POST['tags']);
						$author = mysqli_real_escape_string($db->link1, $_POST['author']);
						$userid = mysqli_real_escape_string($db->link1, $_POST['userid']);
                ...
                <div class="block">               
                 <form action="addpost.php" method="post" enctype="multipart/form-data" class="addPostForm">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="select" name="cat" class="medium">
						...
						<tr>
                            ...
                            <td>
                                <input type="text" name="author" value="<?php echo $user; ?>" class="medium" />
								
								<input type="hidden" name="userid" value="<?php echo $user; ?>" class="medium" />
                            </td>
                        </tr>
