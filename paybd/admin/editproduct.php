	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		if(!empty($bookId))
		{
			if(!empty($branchId))
			{
				...
				if($productUpdate)
				{
					echo "<span style='color:green;font-size:18px;'>Update Successfully.</span>"; 
				}
				else
				{
					echo "<span style='color:red;font-size:18px;'>Not Inserted !</span>";
				}
			}
			else
			{
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
				...
				<tr>
                    ...
                    <td>
                        <input type="text" value="<?php echo $productResult['qty']; ?>" name="qty" />
                    </td>
                </tr>
